 ...
 * @author cfregly
 */
public class ZooKeeperPathCacheConfigurationSource implements WatchedConfigurationSource, Closeable {
    private static final Logger logger = LoggerFactory.getLogger(ZooKeeperPathCacheConfigurationSource.class);
     ...
     *
     */
    public ZooKeeperPathCacheConfigurationSource(CuratorFramework client, String configRootPath) {
        this.client = client;
